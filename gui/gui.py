...
app.layout = html.Div([
    html.Div([
        #[dcc.Upload(html.Button('Load', style={'display': 'inline-block'}), id='upload-data', multiple=False), html.Button('Save', id='btn-download', style={'display': 'inline-block', 'margin-left': '10px'}), dcc.Download(id='download-data')]),
